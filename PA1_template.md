Add csv file. Read data frame and show summary statistics

``` r
activity <- read.csv("~/Downloads/DSD_Coursera/Reproducible Research/Week 2/activity.csv", stringsAsFactors=FALSE)
str(activity)
```
...
![](PA1_template_files/figure-markdown_github/barplot-1.png)
...
![](PA1_template_files/figure-markdown_github/histogram-1.png) The mean of the total number of steps taken per day:
...
![](PA1_template_files/figure-markdown_github/daily-1.png)
...
![](PA1_template_files/figure-markdown_github/histogram_no_NAs-1.png)
...
![](PA1_template_files/figure-markdown_github/weekend_comparison-1.png)
